...
namespace Bonsai.Migrations
{
    ...
    [Migration("20190904130228_RenameMealPlanCalendar")]
    partial class RenameMealPlanCalendar
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bonsai.Persistence.Model.MealPlanCalendar", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Bonsai.Persistence.Model.MealPlan", b =>
                {
                    b.HasOne("Bonsai.Persistence.Model.MealPlanCalendar")
                        .WithMany("MealPlans")
            ...
            modelBuilder.Entity("Bonsai.Persistence.Model.MealPlanCalendar", b =>
                {
                    b.HasOne("Bonsai.Persistence.Model.UserData", "UserData")
                        ...
                        .HasForeignKey("Bonsai.Persistence.Model.MealPlanCalendar", "UserDataId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
